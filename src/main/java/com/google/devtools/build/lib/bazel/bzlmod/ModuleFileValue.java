...
public abstract class ModuleFileValue implements SkyValue {
  ...
  public abstract static class RootModuleFileValue extends ModuleFileValue {
     ...
     *  cannot touch any imported segments. This is unsatisfactory; we should do it properly at some
     *  point, although that seems quite difficult.
     */
    public abstract ImmutableMap<String, CompiledModuleFile> getImportLabelToCompiledModuleFile();
